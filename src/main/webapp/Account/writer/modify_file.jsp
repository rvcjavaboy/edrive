			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major">
						<h2>Modify File</h2>
							<table>
				<tr><td><b>Name</b></td><td><b>Author</b></td><td><b>Modifed</b></td><td><b>Update</b></td></tr>	
						...
						try{
							...
							while(rst.next()){
								...
								if(rst1.next()){
									...
									ResultSet rst2=st3.executeQuery("select id,name_file,author,modifed from files where id="+rst.getInt(1)+"");
										while(rst2.next()){
											System.out.println("Gate 3");
	out.println("<tr><td><a href=WriterSendKey?reqest_id="+rst2.getInt(1)+" class='button small'>"+rst2.getString(2)+"</a></td><td>"+rst2.getString(3)+"</td><td>"+rst2.getString(4)+"</td><td><a href=sendModifyFileKey?reqest_id="+rst2.getInt(1)+"&author="+rst2.getString(3)+" class='button small'>Update</a></td></tr>	");								
										}
