		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<form action="modifyuploadfile?reqest_id=<%=request.getParameter("reqest_id")%>&author=<%=request.getParameter("author")%>" enctype="multipart/form-data" onsubmit="return chkSize()" method="post">
				<center>
				<table>
				<%
				//if(b){
			String s=request.getParameter("modify_file_status");
			if(s!=null&&s!=""){
			out.println("<center><tr style='color:red;font-weight:bold;'><td>"+s+"<td></tr><center>");	
				
			}
			System.out.println("Hidden Filed"+request.getParameter("reqest_id"));
			//	}
			%>
