			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major">
						<h2>Files</h2>
						<table>
<tr><td><b>File Name</b></td><td><b>Share</b></td><td><b>Modify By</b></td><td><b>Size</b></td></tr>						
<% 
try{
	if(b){
	Connection con=MyConnection.getConnection();
	Statement st=con.createStatement();
	String query="select   id,name_file,modifed,size from files where author='"+(String)session.getAttribute("c_email")+"'";
	System.out.println(query);
	ResultSet rst=st.executeQuery(query);
	while(rst.next()){
out.print("<tr><td><a href=CreatorSendKey?req_id="+rst.getInt(1)+" class='button small'>"+rst.getString(2)+"</a></td><td><a href=share_user.jsp?file_id="+rst.getInt(1)+" class='button small'>Share</a></td><td>"+rst.getString(3)+"</td><td>"+rst.getString(4)+"Bytes</td></tr>");		
