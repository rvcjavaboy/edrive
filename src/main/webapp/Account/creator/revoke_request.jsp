...
<html lang="en">
	...
	<body>
		...
		<!-- Main -->
			...
			%>
					<form action='../../revokerequest' method="post">
					...
					<%if(b){
						...
						while(rst.next()){
							...
							String query="select * from revoke_user where reg_id="+rst.getInt(1);
							System.out.println(query);
							ResultSet r=st1.executeQuery(query);
							if(r.next()){
								out.println("<tr><td>"+rst.getString(2)+"</td><td>"+rst.getString(3)+"</td><td><input type='checkbox' id='"+rst.getInt(1)+"' name="+rst.getInt(1)+" checked><label for='"+rst.getInt(1)+"'>Revoke</label></td></tr>");
								//st1.executeUpdate("delete  from revoke_user where reg_id="+rst.getInt(1)+" AND sender='"+(String)session.getAttribute("email")+"'")	;
							}else{
								out.println("<tr><td>"+rst.getString(2)+"</td><td>"+rst.getString(3)+"</td><td><input type='checkbox' id='"+rst.getInt(1)+"' name="+rst.getInt(1)+"><label for='"+rst.getInt(1)+"'>Revoke</label></td></tr>");
