...
<html lang="en">
	...
	<%
		if(b){
			...
			%>
		<form action= "checkModifedFileKey?reqest_id=<%=file_id%>" method="post">	
		...
		<input type="hidden" value=<%=file_id%> name="request_id"/>
			
	</table>
	<center><input type="submit" class="button special" Value="Download"></center>
