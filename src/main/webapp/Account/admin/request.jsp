				...
				<div class="container">
					<header class="major">
						<h2>Register Request</h2>
									...
									<table>
												<%
			String s1=request.getParameter("status_request");
			if(s1!=null&&s1!=""){
			out.println("<center><tr style='color:red;font-weight:bold;'><td>"+s1+"<td></tr><center>");	
				
			}
			%>
<tr><td><b>User Name</b></td><td><b>Email Id</b></td><td><b>Type</b></td><td><b>Accept</b></td></tr>						
<% 
try{
	if(check){
	Connection con=MyConnection.getConnection();
	Statement st=con.createStatement();
	String query="select name,email,type,id from regi where a_status=1 AND admin_auth=0";
			System.out.println(query);
	ResultSet rst=st.executeQuery(query);
	while(rst.next()){
		out.println("<tr><td>"+rst.getString(1)+"</td><td>"+rst.getString(2)+"</td><td>"+rst.getString(3)+"</td><td><input type='checkbox' id='"+rst.getString(1)+"' name="+rst.getString(4)+"><label for='"+rst.getString(1)+"'>Accept</label></td></tr>");
