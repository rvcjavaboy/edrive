...
@Date:27/3/2016
-->
<%@page import="com.db.Connection.MyConnection,java.sql.*"%>
...
<html lang="en">
	<head>
		...
		<%@page language="java" import="com.admin.sessionDAO.*" %>
		<% 
			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major">
						...
						<table>
																<%
			String s1=request.getParameter("delete_status");
			if(s1!=null&&s1!=""){
			out.println("<center><tr style='color:red;font-weight:bold;'><td>"+s1+"<td></tr><center>");	
				
			}
			%>	
						<tr><td><b>Name</b></td><td><b>Email</b></td><td><b>View</b></td></tr>
						<%
						Connection con=MyConnection.getConnection();
						Statement st=con.createStatement();
						ResultSet rst=st.executeQuery("select * from feed where status=0");
						while(rst.next()){
							out.println("<tr><td>"+rst.getString(2)+"</td><td>"+rst.getString(3)+"</td><td><a href=viewfeed.jsp?feed_id="+rst.getInt(1)+" class=button small>View</a></td></tr>");
