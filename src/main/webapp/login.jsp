		...
		<!-- Main -->
			...
			<%@page language="java" %>
					<header class="major">
						...
						<center>
						<form action="loginServlet"  method="post" onsubmit='return formValidator()'>
	<table>
	<%
		...
		<tr><td><b>Enter Email ID</b></td><td><input type="text" id='email' value placeholder="Email Id" name="email" style="width:70%;font-family: cursive;"></td></tr>
		<tr><td><b>Enter  Password</b></td><td><input type="password" id='pass'value placeholder="Password" name="pass" style="width:70%;font-family: cursive;"></td></tr>
		...
		<tr><td><a href="forgotpass.jsp" class="button  small" >Forgot Password</a></td></tr>	
