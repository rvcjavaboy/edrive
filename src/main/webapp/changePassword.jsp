		...
		<!-- Main -->
			...
			<%@page language="java" %>
					<header class="major">
						...
						<center>
						<form action="chpassword"  method="post" onsubmit='return formValidator()'>
	<table>
			<%
			String s=request.getParameter("passmatch_status");
			if(s!=null&&s!=""){
			...
			%>
			<%
			out.println("<input type='hidden' value='"+request.getParameter("email")+"' name='email'>");
			%>
		<tr><td><b>Password</b></td><td><input type="password" id='pass' value placeholder="password" name="pass" style="width:70%;font-family: cursive;"></td></tr>
		<tr><td><b>Confirm Password</b></td><td><input type="password" id='cpass'value placeholder="Password" name="cpass" style="width:70%;font-family: cursive;"></td></tr>
				</td></tr>	
